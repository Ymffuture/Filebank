...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-[#fff]">
      <Helmet>
        <title>About Us | famacloud by Qurovex</title>
        <meta name="description" content="Learn about famacloud — a secure file management platform by Qurovex Institute." />
      </Helmet>
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        >
          <Typography>
            <Title level={2} className="text-center text-[#1E90FF]">About famacloud</Title>
            <Paragraph className="text-center">
              <Text strong>famacloud by Qurovex</Text> is a secure, cloud-powered file management platform.
            ...
            <Space size="large" direction="vertical" className="w-full">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                >
                  ...
                  <Paragraph>Whether you're an individual or a team, famacloud simplifies your file management.</Paragraph>
                </Card>
              </div>
              ...
              <Paragraph>
                At <Text strong>famacloud</Text>, we aim to empower users to manage their digital files with ease, speed, and security.
