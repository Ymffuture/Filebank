...
export default function ChangePlanPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#202124] via-[#a52a2a] to-white p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <Paragraph className="bg-[#333] text-yellow-300 p-3 rounded-md text-sm mb-6">
