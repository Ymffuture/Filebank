...
import {
  ...
  Form, Input, Badge as AntBadge, Steps
} from 'antd';
...
export default function ChangePlanPage() {
  ...
  const renderStatusProgress = () => {
    ...
    const currentStep = stepMap[upgradeStatus] ?? 0;
      ...
      <div className="mt-6">
        <Steps
          ...
          items={[
            ...
            {
              title: upgradeStatus === 'rejected' ? 'Rejected' : 'Approved',
              icon:
        ...
        {upgradeStatus === 'rejected' && statusData?.rejectionReason && (
          <Paragraph type="danger" style={{ color: 'red', marginTop: 8 }}>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 p-6">
        ...
        <Paragraph style={{ color: 'gold', background: '#333', padding: '6px 10px', borderRadius: '6px' }}>
          After sending the WhatsApp message, return here and paste your transaction code.
          The code will be verified by Famacloud.
        </Paragraph>
              ...
              <Col xs={24} sm={12} md={8} key={plan.name}>
                <Card
                  ...
                  style={{
                    ...
                    boxShadow: isSelected ? '0 4px 20px rgba(30,144,255,0.25)' : '0 2px 8px rgba(0,0,0,0.05)',
                    borderRadius: '12px',
                  }}
                  actions={[
                    <Button
                      ...
                      style={{
                        ...
                        boxShadow: !isCurrent && '0 4px 12px rgba(22, 119, 255, 0.4)',
                      }}
                ...
                >
                  <Title level={3} style={{ color: '#1E90FF' }}>
                    {plan.price}
                  </Title>
                  ...
                  {isSelected && !isCurrent && renderStatusProgress()}
                </Card>
              </Col>
            );
          })}
